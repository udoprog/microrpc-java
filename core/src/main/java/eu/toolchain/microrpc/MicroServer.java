...
public class MicroServer implements AutoCloseable {
    ...
    private MicroServer(AsyncFramework async, MicroNetwork network, int maxRetries, long retryBackoff) {
        this.async = async;
    ...
    public static class Builder {
        ...
        public MicroServer build() {
            ...
            return new MicroServer(async, network, maxRetries, retryBackoff);
        }
    }
}
