...
import eu.toolchain.microrpc.MicroConnectionProvider.PendingRequestContext;
...
final class NettyMicroConnection extends AbstractMicroConnection {
    ...
    private final MicroConnectionProvider provider;
    ...
    public NettyMicroConnection(AsyncFramework async, MicroConnectionProvider provider, Direction direction,
            UUID peerId, Channel channel) {
        this.async = async;
    ...
    private <R> AsyncFuture<R> receive(final Serializer<R> serializer, final UUID requestId) {
        ...
        final PendingRequestContext context = provider.createPending(this, requestId, future);
